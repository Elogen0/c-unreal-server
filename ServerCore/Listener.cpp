...
bool Listener::StartAccept(ServerServiceRef service)
{
	...
	{
		AcceptEvent* acceptEvent = exnew<AcceptEvent>();
...
void Listener::ProcessAccept(AcceptEvent* acceptEvent)
{
	...
	//getpeername으로 방금 접속한 유저의 정보 추출
